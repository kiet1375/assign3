...
<head>
	...
	<?php require_once("JavaScript/DetailsScript.php") ?>
</head>
<body onload="details()">
    <!-- *** TOPBAR *** -->
    <div id="top">
                                ...
                                <div class="yamm-content">
                                    <div class="row">
                                        <div class="col-sm-6"> <!-- col-sm-3 is changed to col-sm-6 by Shang-->
                                            <h5>Furniture</h5>
                                            <ul>
                                                <li><a href="shop-furniture.html?chairs">Chairs</a>
                                                </li>
                                                <li><a href="shop-furniture.html?beds">Beds</a>
                                                </li>												
                                                <li><a href="shop-furniture.html?tables">Tables</a>
                                                </li>
												<li><a href="shop-furniture.html?storage">Storage</a>
                                                </li>
                                        ...
                                        <div class="col-sm-6"> <!-- col-sm-3 is changed to col-sm-6 by Shang-->
                                            <h5>Accessories</h5>
                                            <ul>
                                                <li><a href="shop-accessories.html?homeDeco">Home Deco</a>
                                                </li>
                                                <li><a href="shop-accessories.html?textile">Textiles & Rugs</a>
                                                </li>
												<li><a href="shop-accessories.html?lighting">Lighting</a>
                                                </li>
												<li><a href="shop-accessories.html?potPlant">Plant pots & Stands</a>
                                                </li>												
                                            </ul>
                                        </div>                                        
                                    </div>
 ...
 _________________________________________________________ -->
                    <div class="panel panel-default sidebar-menu">
                        ...
                        <div class="panel-body">
                            <ul class="nav nav-pills nav-stacked category-menu">
                                <li class="active">
                                    <a href="shop-furniture.html">furniture <span class="badge pull-right">12</span></a>
                                    <ul>
                                        <li><a href="shop-furniture.html?chairs">Chairs</a>
                                        </li>
                                        <li><a href="shop-furniture.html?beds">Beds</a>
										...
										<li><a href="shop-furniture.html?storages">Storage</a>
                                        </li>
                                    </ul>
                                </li>
                                <li>
                                    <a href="shop-accessories.html">Accessories  <span class="badge pull-right">12</span></a>
                                    <ul>
                                        <li><a href="shop-accessories.html?homeDeco">Home Deco</a>
                                        </li>
                                        <li><a href="shop-accessories.html?textileRug">Textiles & Rugs</a>
                                        </li>
										<li><a href="shop-accessories.html?lighting">Lighting</a>
                                        </li>
										<li><a href="shop-accessories.html?potStand">Plant pots & Stands</a>
                                        </li>												
                                    </ul>
                                </li>
                            </ul>
                ...
                <div class="col-md-9">
                    ...
                    <div class="row" id="productMain">
                        <div class="col-sm-6">
                            <div id="mainImage">
                                <img id="img1" src="img/detailbig1.jpg" alt="" class="img-responsive" width="460" height="571">
                            </div>
                        ...
                        <div class="col-sm-6">
                            <div class="box">
                                <h1 id="h1Element" class="text-center">Chair</h1>
                                <p class="goToDescription"><a href="#details" class="scroll-to">Scroll to product details, material and care </a>
                                </p>
                                <p id= "price" class="price">$124.00</p>

                                <p class="text-center buttons">
                                    <a id="addCart" href="basket.html" class="btn btn-primary"><i class="fa fa-shopping-cart"></i> Add to cart</a> 
									<!--
                    ...
                    <div class="box" id="details">
                            ...
                            <h5 style="display:inline">Brand: </h5><h5 style="display:inline" id="brand"></h4>
                            <p id="description"></p>
                            <h4>Material and care</h4>
                            <ul>
                                <li id= "material1" hidden></li>
                                <li id= "material2" hidden></li>
                            </ul>
                            <!-- <h4>Size & Fit</h4>
                            <ul>
                                <li>Regular fit</li>
